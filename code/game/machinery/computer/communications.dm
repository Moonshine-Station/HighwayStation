...
/obj/machinery/computer/communications/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/ui_state)
	...
	switch (action)
		...
		if ("purchaseShuttle")
			...
			minor_announce("[purchaser_name] купил [shuttle.name] за [shuttle.credit_cost] [MONEY_NAME_AUTOPURAL(shuttle.credit_cost)].[shuttle.extra_desc ? " [shuttle.extra_desc]" : ""]" , "Покупка шаттла")
