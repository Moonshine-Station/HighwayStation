...
if command -v rg >/dev/null 2>&1; then
	...
	code_files="code/**/**.dm modular_content/**/**.dm" # BANDASTATION EDIT - Add modular_content/
	map_files="_maps/**/**.dmm"
	shuttle_map_files="_maps/shuttles/**.dmm"
	code_x_515="code/**/!(__byond_version_compat).dm modular_content/**/!(__byond_version_compat).dm" # BANDASTATION EDIT - Add modular_content/
else
	pcre2_support=0
	grep=grep
	code_files="-r --include=code/**/**.dm --include=modular_content/**/**.dm" # BANDASTATION EDIT - Add modular_content/
	map_files="-r --include=_maps/**/**.dmm"
	shuttle_map_files="-r --include=_maps/shuttles/**.dmm"
	code_x_515="-r --include=code/**/!(__byond_version_compat).dm --include=modular_content/**/!(__byond_version_compat).dm" # BANDASTATION EDIT - Add modular_content/
fi
