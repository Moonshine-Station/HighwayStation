/mob/living/basic/lizard/big
	...
	icon = 'modular_content/mobs/icons/animal.dmi'
	icon_state = "iguana"
	icon_living = "iguana"
	...
	attack_sound = 'sound/items/weapons/bite.ogg'
	death_sound = 'modular_content/mobs/sound/lizard_death_big.ogg'
	damaged_sounds = list('modular_content/mobs/sound/lizard_damaged.ogg')
