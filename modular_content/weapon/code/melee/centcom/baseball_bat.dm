/obj/item/melee/baseball_bat/homerun/centcom
	...
	throwforce = 12
	wound_bonus = -50
	icon = 'modular_content/weapon/icons/melee/baseball.dmi'
	lefthand_file = 'modular_content/weapon/icons/melee/inhands/lefthand.dmi'
	righthand_file = 'modular_content/weapon/icons/melee/inhands/righthand.dmi'
